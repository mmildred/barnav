      ...
      >
        <div className="py-6 px-4 border-t border-gray-100">
          ...
          <div className="mt-6 pt-6 border-t border-gray-100">
            <Link to="/login">
              <button className="w-full bg-linear-to-r from-gray-800 to-gray-900 text-white font-semibold py-4 px-4 rounded-lg hover:from-gray-900 hover:to-gray-800 transition-all duration-300 shadow-md flex items-center justify-center gap-3">
